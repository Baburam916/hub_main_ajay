...
import Update_shipment from "./update_shipment";
import { FormInput, FormLabel } from "../../../base-components/Form";
import Button from "../../../base-components/Button";
import { useAlert } from "../../../ContextProvider/AlertContext";
import { Editbooking_details } from "../../../AllServices/services";
import LoadingIcon from "../../../base-components/LoadingIcon";
import { Box, ClipboardList, Truck, User } from "lucide-react";

import update_shipmenticon from "../../../assets/images/update_shipmenticon.png";
const index = () => {
  ...
  const getData = async () => {
    if (hub_id) {
      ...
      showAlert("You are not authorized to perform this activity", "warning");
      return;
    }
  };
            ...
            <div className="w-full awbsearchbg bg-[#f7f8f9] border-b border-[#fff0cd] py-3 px-3 md:py-3 md:px-5  ">
              <div className="flex items-center  ">
                <figure className="hidden lg:flex items-center justify-center  mr-1   bg-[#fff] rounded-full border border-[#fff0c9] w-[65px] h-[65px] ">
                  <img src={update_shipmenticon} alt="" className="w-[44px] " />
                </figure>
