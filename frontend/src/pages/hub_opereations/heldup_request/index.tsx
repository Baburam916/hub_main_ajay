...
const index = () => {
  ...
  const handleSubmitHeldUpRequest = async () => {
    ...
    try {
      ...
      if (response?.status == 200 || response?.status == 201) {
        showAlert(
          response?.data?.message || "Held up request created successfully",
        );
        setAwbNo("");
        setHeldUpReason("");
        ...
        <div className="mt-1 w-full bg-white rounded-[10px]  border border-white">
            ...
            <div className="flex-wrap lg:flex-none flex gap-2 items-center justify-between w-full">
              <div>
                <div className="flex items-center gap-2">
                  <i className=" w-[25px] h-[25px]  rounded-lg flex items-center justify-center bg-mustard">
                    <Loader className="w-[17px]  text-[#fff] " />
                  </i>
                  <h4 className="text-[16px] font-medium"> Held Up Request</h4>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div className="flex items-center gap-4">
                  ...
                  <Button
                    className="p-2 px-5 rounded-md bg-mustard text-white border-none"
          ...
          <div className="w-full p-2 lg:p-3 border-b border-gray-200 bg-[#f1f1f1]">
            <div className="flex flex-wrap items-end gap-4 ">
              ...
              <div className="flex-wrap lg:flex-nowrap flex gap-2 items-center">
                <FormLabel htmlFor="to_date" className="whitespace-nowrap !m-0">
                  To Date
                </FormLabel>
                <FormInput
                  id="to_date"
              ...
              <Button
                ...
                className="p-2 px-5 rounded-md bg-mustard text-white flex items-center border-none"
              >
            ...
            <Modal
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <FormInput
                      ...
                      value={awbNo}
                      onChange={(e) =>
                        setAwbNo(e.target.value.replace(/\s/g, ""))
                      }
                      onKeyDown={(e) =>
                        e.key === "Enter" && handleSubmitHeldUpRequest()
                      }
              ...
              footer={
                <div className="flex justify-end gap-4">
                  <Button
                    className="px-4 py-1 rounded-lg bg-gray-400 text-white border-none"
                  ...
                  <Button
                    className="px-4 py-1 rounded-lg bg-mustard text-white flex items-center  border-none"
