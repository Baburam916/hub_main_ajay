...
import { Box, ClipboardList, FileCheck, User } from "lucide-react";

import AOS from "aos";
import "aos/dist/aos.css";

import changebendericon from "../../../assets/images/changebendericon.png";
                ...
                <div className="block lg:flex items-center justify-between w-full">
                  <div>
                    <div className="flex items-center gap-2 mb-2 lg:mb-0">
                      ...
                      <h4 className="text-[16px] font-medium">Change Vendor</h4>
                    </div>
                  </div>
                </div>
              </div>
