...
const Alert: AlertComponent = forwardRef(
  <C extends React.ElementType>(
    ...
    const error = [
      "bg-error border-error text-white bg-red-400", // Default
      "dark:border-error", // Dark mode
    ];
    const warning = [
      "bg-warning border-warning text-white", // Default
    ...
    const outlineError = [
      "border-error text-red-900", // Default
      "dark:border-error",
    ];
    ...
    const softError = [
      "bg-error border-error text-white", // Default
      "dark:border-error", // Dark mode
    ];
    const softPending = [
      ...
      >
        <Component
          ...
          className={twMerge([
            ...
            variant=="outline-error"&&outlineError,
