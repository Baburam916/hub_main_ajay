...
const Button: ButtonComponent = forwardRef(
  <C extends React.ElementType>(
    ...
    // General Styles
    const generalStyles = [
      "transition duration-200 border shadow-sm inline-flex items-center justify-center  px-1 rounded-md font-medium cursor-pointer", // Default
    ...
    const mustard = [
      "bg-mustard border-mustard text-white dark:border-mustard",
    ];
    const secondary = [
