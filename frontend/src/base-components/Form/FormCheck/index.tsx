  ...
  return (
    <input
      ...
      className={twMerge([
        ...
        // On checked
        "[&[type='radio']]:checked:bg-mustard [&[type='radio']]:checked:border-mustard [&[type='radio']]:checked:border-opacity-10",
        "[&[type='checkbox']]:checked:bg-mustard [&[type='checkbox']]:checked:border-mustard [&[type='checkbox']]:checked:border-opacity-10",
